...
{ 
    ...
    public override ViewResult View(string viewName, object model)
    {
        ...
        {
            Logger.LogWarning("View called without a model and view name {ViewName}", viewName);
        }
    ...
    public override PartialViewResult PartialView(string viewName, object model)
    {
        ...
        {
            Logger.LogWarning("PartialView called without a model and view name {ViewName}", viewName);
        }
